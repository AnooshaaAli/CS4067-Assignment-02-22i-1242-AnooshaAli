  ...
  return (
    <div className="bookings-container">
          ...
          <table className="bookings-table">
            <thead>
              <tr>
                ...
                <th onClick={() => handleSort("num_tickets")} className="sortable-header">
                  Tickets {sortField === "num_tickets" && <span className="sort-indicator">{sortDirection === "asc" ? "↑" : "↓"}</span>}
                </th>
                <th>Actions</th>
              </tr>
            </thead>
      ...
      <div className="bookings-summary">
        ...
        <p>Total tickets: {sortedAndFilteredBookings.reduce((sum, booking) => sum + booking.num_tickets, 0)}</p>
      </div>
    </div>
  );
};
