...
2. **Step 2: Set Up Database Connection**  
   ...
   ```python
    ...
    DATABASE_URL = "postgresql+asyncpg://yourusername:yourpassword@localhost:5432/yourdbname"  # Replace yourpassword and yourdbname with your actual PostgreSQL credentials.
